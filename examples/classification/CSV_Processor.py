...
def datahandler(i, gesture, row_info):
    base_dir = "Test_Data"  # Ensure this is the correct path
...
with open("C:\\Users\\scott\\OneDrive\\Documents\\GitHub\\myo_ecn\\examples\\classification\\Test_Data\\BCICIV_2a_all_patients.csv",
          'r') as file:
    ...
    print(f"CSV file has been sorted. Please see Test_Data. Total time: {total_time:.4f} seconds.")